...
def parse_args():
    ...
    parser.add_argument('--annotations', default='ddsm_calc_retinanet_data/annotations.csv',
                        help='Path to the annotations CSV file')
    parser.add_argument('--class_map', default='ddsm_calc_retinanet_data/class_map.csv',
                        help='Path to the class_map CSV file')
    parser.add_argument('--output_dir', default='ddsm_calc_visualization',
...
def main():
    ...
    for ann in tqdm(annotations):
        ...
        if not os.path.exists(img_path) and os.path.exists(os.path.join('ddsm_calc_retinanet_data', img_path)):
            img_path = os.path.join('ddsm_calc_retinanet_data', img_path)
